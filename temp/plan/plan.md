...
| `build_windows_release_bat_vs_cmake_registry` | Build_Windows_Release.bat 自动读取 VS 注册表 CMake 环境 | Done | M4 - 收尾 | `windows_build_bat_setup` | [build_windows_release_bat_vs_cmake_registry_plan.md](./build_windows_release_bat_vs_cmake_registry_plan.md) | [build_windows_release_bat_vs_cmake_registry_done_plan.md](./build_windows_release_bat_vs_cmake_registry_done_plan.md) |
